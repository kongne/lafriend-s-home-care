  ...
  return (
    ...
    >
      ...
      <Button
        ...
        size="icon"
        onClick={prevSlide}
        className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-20 bg-card/30 hover:bg-card/50 text-primary-foreground h-12 w-12 rounded-full"
      ...
      <Button
        ...
        size="icon"
        onClick={nextSlide}
        className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-20 bg-card/30 hover:bg-card/50 text-primary-foreground h-12 w-12 rounded-full"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center lg:text-left lg:mx-0">
          <div
            key={currentSlide}
            className="text-primary-foreground space-y-6 animate-fade-in"
          >
