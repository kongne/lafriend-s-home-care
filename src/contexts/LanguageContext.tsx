...
export const translations: Translations = {
 ...
 'hero.learnMore': { fr: 'DÉCOUVRIR NOS SERVICES', en: 'DISCOVER OUR SERVICES' },
  ...
  'faq.a2': { fr: 'Vous pouvez réserver directement sur notre site en remplissant le formulaire de réservation, nous appeler au +237 693 96 55 01, ou nous contacter via WhatsApp. Nous confirmerons votre rendez-vous dans les plus brefs délais.', en: 'You can book directly on our website by filling out the booking form, call us at +237 693 96 55 01, or contact us via WhatsApp. We will confirm your appointment as soon as possible.' },
