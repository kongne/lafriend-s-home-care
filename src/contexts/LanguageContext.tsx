...
export const translations: Translations = {
 ...
 'hero.learnMore': { fr: 'DÉCOUVRIR NOS SERVICES', en: 'DISCOVER OUR SERVICES' },
  ...
  'services.nanny.desc': { fr: 'Service de placement de nounou qualifiée pour la garde d\'enfants.', en: 'Professional nanny placement service for childcare.' },
  'services.nanny.f1': { fr: 'Professionnelles qualifiées', en: 'Qualified professionals' },
  'services.nanny.f2': { fr: 'Sélection rigoureuse', en: 'Rigorous selection' },
  'services.nanny.f3': { fr: 'Suivi personnalisé', en: 'Personalized follow-up' },
  'services.cook': { fr: 'Service de Cuisinière', en: 'Cook Service' },
  'services.cook.desc': { fr: 'Service de cuisinière professionnelle pour votre domicile.', en: 'Professional cook service for your home.' },
  'services.cook.f1': { fr: 'Cuisine familiale', en: 'Family cooking' },
  'services.cook.f2': { fr: 'Menus équilibrés', en: 'Balanced menus' },
  'services.cook.f3': { fr: 'Régimes spécifiques', en: 'Specific diets' },
  'services.industrial': { fr: 'Nettoyage Industriel', en: 'Industrial Cleaning' },
  'services.industrial.desc': { fr: 'Solutions de nettoyage professionnelles pour environnements industriels.', en: 'Professional cleaning solutions for industrial environments.' },
  'services.industrial.f1': { fr: 'Équipement lourd', en: 'Heavy equipment' },
  'services.industrial.f2': { fr: 'Normes de sécurité', en: 'Safety standards' },
  'services.industrial.f3': { fr: 'Personnel certifié', en: 'Certified staff' },
