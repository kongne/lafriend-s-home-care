...
import { sendEmail, corsHeaders } from "../_shared/email-service.ts";
      ...
      <body style="font-family:Arial,sans-serif;margin:0;padding:0;background:#f4f4f4;">
        <div style="max-width:600px;margin:0 auto;background:white;">
          ...
          <div style="padding:30px;">
            <h2 style="color:#1a1a2e;">🎉 Félicitations ${referrerName}!</h2>
            <p style="color:#666;line-height:1.6;">Votre ami(e) <strong>${referredName}</strong> (${referredEmail}) vient de s'inscrire!</p>
    ...
    const referredHtml = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"></head>
      <body style="font-family:Arial,sans-serif;margin:0;padding:0;background:#f4f4f4;">
        <div style="max-width:600px;margin:0 auto;background:white;">
          ...
          <div style="padding:30px;">
            <h2 style="color:#1a1a2e;">🎁 Bienvenue ${referredName}!</h2>
            <p style="color:#666;line-height:1.6;">Merci de vous être inscrit(e) grâce à <strong>${referrerName}</strong>!</p>
